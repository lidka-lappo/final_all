...
class B2EventAction : public G4UserEventAction
{
  public:
    ...
    bool DidAnnihilationHappen(){return fAnnihilationFlag;};
    void UpdateAnnihilation(){fAnnihilationFlag = true;};

    //TNtuple* GetNtuple(){ return fRunAction->GetNtuple();};

  private:
    B2RunAction* fRunAction;
    bool fAnnihilationFlag;
